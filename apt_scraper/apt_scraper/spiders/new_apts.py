...
class NewAptsSpider(scrapy.Spider):
    name = "new_apts"
    start_urls = ['https://losangeles.craigslist.org/search/apa?sort=date&search_distance=5&postal=90404&max_price=2100&min_bedrooms=1&max_bedrooms=1&availabilityMode=0&pets_cat=1']
